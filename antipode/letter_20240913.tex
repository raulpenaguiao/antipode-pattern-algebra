...
On rewritting the introduction, we were carefull in referrencing that pattern Hopf algebras arise from any species with restrictions, pushed Figure 1 to chapter 3, and added pointers to specific elements of the article as suggested.

When we submitted this paper we were under the impression that we would be leaving this result for another publication, but that did not quite come to fruition.
